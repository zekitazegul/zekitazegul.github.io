...
navContact: "Contact",
    ...
    heroLocation: "Poortugaal – Rotterdam, Netherlands",
    ...
    otherEyebrow: "ADDITIONAL INFORMATION",
    ...
    otherTitle: "Additional Information",
    other1: "Driving licence B",
    other2: "Available for onsite work",
    other3: "Available to work across multiple locations",
    other4: "Experience with direct end-user support",
    other5: "Professional and customer-oriented work attitude",
    other6: "Practical experience with laptop and computer maintenance",
    other7: "Strong interest in hardware, workplace support and IT",
...
nl: {
    ...
    navOther: "Aanvullende informatie",
    ...
    heroLabel: "IT PROFESSIONAL",
    heroLocation: "Poortugaal – Rotterdam, Nederland",
    ...
    otherEyebrow: "AANVULLENDE INFORMATIE",
    ...
    otherTitle: "Aanvullende Informatie",
    other1: "Rijbewijs B",
    other2: "Beschikbaar voor onsite werkzaamheden",
    other3: "Beschikbaar voor werkzaamheden op meerdere locaties",
    other4: "Ervaring met directe ondersteuning van eindgebruikers",
    other5: "Professionele en klantgerichte werkhouding",
    other6: "Praktische ervaring met laptop- en computeronderhoud",
    other7: "Affiniteit met hardware, werkplekken en IT-support",
...
const sectionEyebrows = {
    "#profile .section-eyebrow": selectedTranslations.profileEyebrow,
    "#skills .section-eyebrow": selectedTranslations.skillsEyebrow,
    "#competencies .section-eyebrow": selectedTranslations.competenciesEyebrow,
    "#experience .section-eyebrow": selectedTranslations.experienceEyebrow,
    "#education .section-eyebrow": selectedTranslations.educationEyebrow,
    "#languages .section-eyebrow": selectedTranslations.languagesEyebrow,
    "#other .section-eyebrow": selectedTranslations.otherEyebrow,
    "#contact .section-eyebrow": selectedTranslations.contactEyebrow
};
...
const dutchButton = document.getElementById("language-nl");
...
if (dutchButton) {
dutchButton.addEventListener("click", () => setLanguage("nl"));
}
...
console.log("Zeki Tazegul CV website loaded successfully.");
